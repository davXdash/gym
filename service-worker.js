...
const prepareHtml=async response=>{
 ...
 for(const js of ['app-fixes-v15.js','training-v18.js','ux-plan-v19.js','progression-v20.js','final-plan-v21.js','sync-policy-v22.js','coach-v23.js'])if(!html.includes(js))html=html.replace('</body>',`<script type="module" src="js/${js}"></script></body>`);
