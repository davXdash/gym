...
const prepareHtml=async response=>{
 ...
 for(const css of ['patch-v13.css','patch-v14.css','training-v18.css','ux-plan-v19.css','progression-v20.css','final-plan-v21.css','training-mode-v30.css','coach-studio-v32.css','regression-fix-v34.css'])if(!html.includes(css))html=html.replace('</head>',`<link rel="stylesheet" href="css/${css}"></head>`);
 for(const js of ['app-fixes-v15.js','training-v18.js','ux-plan-v19.js','progression-v20.js','final-plan-v21.js','sync-policy-v22.js','coach-v23.js','status-fix-v25.js','status-fix-v26.js','training-mode-v30.js','coach-v31.js','studio-v32.js','regression-fix-v34.js'])if(!html.includes(js))html=html.replace('</body>',`<script type="module" src="js/${js}"></script></body>`);
