...
const prepareHtml=async response=>{
 ...
 for(const css of ['patch-v13.css','patch-v14.css','training-v18.css','ux-plan-v19.css'])if(!html.includes(css))html=html.replace('</head>',`<link rel="stylesheet" href="css/${css}"></head>`);
 for(const js of ['app-fixes-v15.js','training-v18.js','ux-plan-v19.js'])if(!html.includes(js))html=html.replace('</body>',`<script type="module" src="js/${js}"></script></body>`);
