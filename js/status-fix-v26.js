...
function fixShell(){
  ...
  if(title){
    const names={'page-dashboard':'Dave','page-plan':'Trainingsplan Dave','page-calendar':'Kalender Dave','page-weight':'Gewicht Dave','page-measurements':'Umfänge Dave','page-progress':'Fortschritt Dave','page-photos':'Fotos Dave','page-studio':'Studio Dave','page-settings':'Einstellungen Dave'};
